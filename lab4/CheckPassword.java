...
class Password
{
	...
	boolean hasUppercaseCharacterAndSpecialCharacter()
	{
...
public class CheckPassword 
{
	public static void main(String[] args)
	{
		...
		if (checkPassword.hasLowercaseCharacterAndDigit() && !checkPassword.hasUppercaseCharacterAndSpecialCharacter() && checkPassword.hasRequiredLength() && !checkPassword.hasImmediatePattern())
		{
